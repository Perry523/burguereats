<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">Adicionar Produto</h1>
        <p class="text-sm text-gray-500">Crie um novo produto para o estoque</p>
      </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <!-- <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">
                  Preço de Compra <span class="text-red-500">*</span>
                </label>
                <div class="relative">
...
const saveProduct = async () => {
  ...
  try {
    ...
    if (response.success) {
      toast.add({ color: "success", title: "Produto criado com sucesso" });
