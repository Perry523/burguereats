<template>
  <div class="relative flex items-center justify-center">
    <button
      ...
      :class="isTrackingWeb ? 'bg-green-100 text-green-600' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'"
      :title="isTrackingWeb ? 'Pausar rastreamento' : 'Iniciar rastreamento'"
    >
      <UIcon
        :name="isTrackingWeb ? 'i-heroicons-pause-solid' : 'i-heroicons-play-solid'"
